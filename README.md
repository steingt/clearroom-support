...
ClearRoom is a free native iPhone toolkit for inspecting a room for possible hidden-camera clues. It includes a lens viewer, infrared self-check, local-network service discovery, magnetic measurements, a guided checklist, and a private inspection journal.
...
- Camera unavailable: allow Camera in iPhone Settings, close other camera activity, and tap Start camera again. Some cameras have no torch.
- No infrared light: test the selected phone camera with a working infrared remote. Some iPhone cameras filter infrared. No visible light does not rule out a camera.
